...
public class Utility {
	...
	public static int notes[]={1000,500,100,50,10,2,1};
	public static int noteCounts[]=new int[7];
	public static void returnNotes(int change,int pos){
		
		if(pos<notes.length){
		if(change>notes[pos]){
			returnNotes(change,++pos);
		}
		else{
